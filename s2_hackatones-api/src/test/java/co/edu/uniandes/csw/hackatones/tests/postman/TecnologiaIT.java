...
import co.edu.uniandes.csw.hackatones.resources.TecnologiaResource;
...
public class TecnologiaIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "frontstepbystep-api.war")//War del modulo api
                ...
                .addPackage(TecnologiaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(TecnologiaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
