...
import co.edu.uniandes.csw.hackatones.resources.LenguajeResource;
...
public class TecnologiaHackatonIT {
    
    private static final String COLLECTION = "TecnologiaHackatonTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_hackatones-api.war")//War del modulo api
                ...
                .addPackage(LenguajeResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(LenguajeDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
